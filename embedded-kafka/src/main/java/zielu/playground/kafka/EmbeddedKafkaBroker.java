...
public class EmbeddedKafkaBroker extends ExternalResource {
    ...
    public EmbeddedKafkaBroker(int brokerId, String zkConnection) {
        this(brokerId, AvailablePortFinder.getNextAvailable(), zkConnection);
    }

    public EmbeddedKafkaBroker(int brokerId, int port, String zkConnection) {
        this(brokerId, port, zkConnection, new Properties());
    }
    ...
    @Override
    public void before() {
        logDir = TestUtil.createTempDir("kafka-log");
